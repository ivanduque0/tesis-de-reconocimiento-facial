...
interpreter = tf.lite.Interpreter(model_content="home/seguricel/Downloads/modelolite er-iv-di conv2d (128,128,256)(64,128,128) colab 300x300")
        ...
        while True:
            ...
            if results.detections is not None:
                for detection in results.detections:
                    ...
                    interpreter.set_tensor(input_index, preparar('rostrorver.jpg'))
                    interpreter.invoke()
                    prediccion=interpreter.get_tensor(output_index)
                    print(prediccion)
