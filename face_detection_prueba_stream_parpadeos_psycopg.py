...
try:
    ...
    #este trozo sirve por si se quiere agregar los nombres de las personas a una tabla
    #llamada "persona" de la base de datos
    # for persona in imagenes:
    #     nombre = os.path.splitext(persona)[0]
