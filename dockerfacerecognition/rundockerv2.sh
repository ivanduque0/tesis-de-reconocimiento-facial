...
docker run -d --network=dockernetworktesis --net-alias postgres -e POSTGRES_PASSWORD=postgres -p 4443:5432 -v $(pwd)/postgresdata:/var/lib/postgresql/data 02da44b1d4a6
